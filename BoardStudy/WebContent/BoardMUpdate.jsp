...
<h2>BoardUpdate.jsp</h2>
	<form action="memberupdateprocess" method="post" name="updateform" enctype="multipart/form-data">
		아이디<br>
			<input type="text" name="mid" id="mid" maxlength="20" size="50px" value="${memberUpdate.mid}" readonly><br>
			<p></p>	
		이름<br>
			<input type="text" name="mname" id="mname"size="50px" value="${memberUpdate.mname}"><br>
		  	<p></p>	
		생년월일<br>
            <input type="date" name="mbirth" id="mbirth"size="50px" value="${memberUpdate.mbirth}"><br>
            <p></p>	
		이메일<br>
			<input type="text" name="memail" id="memail"size="50px" value="${memberUpdate.memail}"><br>
		  	<p></p>	
		주소<br>
            ...
            <p></p>	
		 휴대전화<br>
            <input type="text" id="mphone" name="mphone" value="${memberUpdate.mphone}" size="50px"onkeyup="phoneCheck()" onblur="disapper()"><br>
		...
		프로필 사진<br>
			...
			<p></p>	
		비밀번호 확인<br>
            <input type="text" name="mpassword" id="mpassword" maxlength="20"size="50px"><br>
             <p></p>	
	</form>
